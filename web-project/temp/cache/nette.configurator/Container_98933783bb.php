<?php
// source: /Applications/XAMPP/xamppfiles/htdocs/collector/web-project/config/common.neon
// source: /Applications/XAMPP/xamppfiles/htdocs/collector/web-project/config/services.neon
// source: array
...
class Container_98933783bb extends Nette\DI\Container
{
	...
	public function createServiceApplication__presenterFactory(): Nette\Application\IPresenterFactory
	{
		$service = new Nette\Application\PresenterFactory(new Nette\Bridges\ApplicationDI\PresenterFactoryCallback(
			$this,
			5,
			'/Applications/XAMPP/xamppfiles/htdocs/collector/web-project/temp/cache/nette.application/touch',
		));
	...
	public function createServiceAssets__registry(): Nette\Assets\Registry
	{
		...
		$service->addMapper(
			...
			rtrim(Nette\Utils\FileSystem::resolvePath('/Applications/XAMPP/xamppfiles/htdocs/collector/web-project/www', 'assets'), '\/'),
			[],
			true,
		),
		);
	...
	{
		return new Nette\Caching\Storages\SQLiteJournal('/Applications/XAMPP/xamppfiles/htdocs/collector/web-project/temp/cache/journal.s3db');
	}
	...
	public function createServiceCache__storage(): Nette\Caching\Storage
	{
		return new Nette\Caching\Storages\FileStorage(
			'/Applications/XAMPP/xamppfiles/htdocs/collector/web-project/temp/cache',
	...
	public function createServiceLatte__latteFactory(): Nette\Bridges\ApplicationLatte\LatteFactory
	{
		return new class ($this) implements Nette\Bridges\ApplicationLatte\LatteFactory {
			public function __construct(
				private Container_98933783bb $container,
			) {
			}
			...
			public function create(): Latte\Engine
			{
				...
				$service->setTempDirectory('/Applications/XAMPP/xamppfiles/htdocs/collector/web-project/temp/cache/latte');
